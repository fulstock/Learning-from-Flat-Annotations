...
parser = argparse.ArgumentParser(description="Entity corruption script.")
parser.add_argument('--input_dir', type=str, required=True, help="Path to flat binder dataset (e.g. data/NEREL-outerflat-binder)")
parser.add_argument('--output_dir', type=str, required=True, help="Path to output damaged dataset")
parser.add_argument('--method', type=str, default="end", choices=["random", "start", "end", "middle", "syntax"])
parser.add_argument('--mask', type=str, default="diglets", choices=["digits", "letters", "diglets", "semicolon", "comma", "onedigit", "oneletter"])
...
original_flatdata = args.input_dir
new_data = args.output_dir
